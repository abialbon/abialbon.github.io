...
$(document).ready(function(){
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function(x) {
            ...
            var urlToOpen = 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&appid=' + '85ad46f83d5801cdebcbc16ab42983e7'
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    updateHTML('#sunrise', 'Sunrise: '+ sunrise.toLocaleString().substr(11))
                    updateHTML('#sunset', 'Sunset: '+ sunset.toLocaleString().substr(11))
                    updateIcon(icon)
                    // Remove preloader
                    $('.spinner').hide();
                    $('.wrapper').fadeIn();
        ...
        $('#preload-text').html("Oops, your location is unavailable and I can't handle this!");
        $('.preload').hide();
    }
